...
* Ubuntu amd64:
    * [`totalmapper_1.4.2-focal_amd64.deb`](https://github.com/ellbur/totalmapper/releases/download/v1.4.0/totalmapper_1.4.2-focal_amd64.deb)
    * [`totalmapper_1.4.2-jammy_amd64.deb`](https://github.com/ellbur/totalmapper/releases/download/v1.4.0/totalmapper_1.4.2-jammy_amd64.deb)
    * [`totalmapper_1.4.2-kinetic_amd64.deb`](https://github.com/ellbur/totalmapper/releases/download/v1.4.0/totalmapper_1.4.2-kinetic_amd64.deb)
* Self-contained Linux binaries (useful for Chrome OS):
    * [`totalmapper-static-linux-amd64-1.4.2.tar.gz`](https://github.com/ellbur/totalmapper/releases/download/v1.4.0/totalmapper-static-linux-amd64-1.4.2.tar.gz)
    * [`totalmapper-static-linux-aarch64-1.4.2.tar.gz`](https://github.com/ellbur/totalmapper/releases/download/v1.4.0/totalmapper-static-linux-aarch64-1.4.2.tar.gz)
